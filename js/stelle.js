const starBlock = document.querySelector(".stars");  //facciamo una costante
const stars = document.querySelectorAll(".stars img"); //richiamiamo, con una costante gli elementi stars che abbiamo creato nell'html
    ...
    star.addEventListener("click", () => {      //aggiungiamo un evento al click   
      starBlock.classList.add("disabled");      //questo, dopo che avremo cliccato l'indice di valutazione bloccherà l'indice fino a che la pagina non verrà aggiornata 
